...
/**
 * Calculate dive plan offline (fallback when API is unavailable)
 */
...
function initCalculationLogic() {
    console.log('Initializing calculation logic');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize calculation logic when the DOM is ready
